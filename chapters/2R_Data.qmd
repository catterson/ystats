...
![facebook’s attempt at measuring more complex categories.](images/2_fb_gender.png)

[Indeed, categories almost always oversimplify the complexity of life, yet are often used by people (and researchers) because they can sometimes be useful and simple shortcuts for us to understand the world.]{.smallcaps} \[\^2r_data-4\]:

[Here's facebook’s attempt](http://abcnews.go.com/blogs/headlines/2014/02/heres-a-list-of-58-gender-options-for-facebook-users) at measuring more complex categories. \[\^2r_data-4\]
...
[a continuous approach to measuring gender.](images/2_genderspectrum.png)[^2r_data-5]
...
The datasets in our class will be stored on Dropbox; you can find a link to this on our course Canvas page (see below).
...
# Part 3 : Finding Past Research For Fun and Profit

psych 214 students do not need to read; prof. will update this later this week tho.

## The Business of Being an Academic
