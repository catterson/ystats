...
Linear models are the foundation of much of statistics, and one important way that scientists make predictions about one variable using knowledge of another variable (or more than one!).

- Learn about how we can define a linear model to make predictions about one variable (the DV) from another (the IV).

- You’ll then learn about $R^2$ (read this as : “R squared”) - professor’s favorite statistic - and how this quantifies the amount of error in our predictions.

- Learn how our good friend the z-score can be used to calculate a correlation coefficient.
:::
