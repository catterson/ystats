...
[![A Sumerian (Modern Iraq) stone tablet representing where locusts and caterpillars had infested different plots of land.](images/clipboard-4017464194.png){fig-align="center"}](https://commons.wikimedia.org/wiki/File:The_oldest_writing_in_the_world_-_The_Sumerian_Stone_Tablet.jpg)
...
- Part 2 covers how to use the programming language R to define and graph a variable to illustrate variation.
- Part 3 reviews the method that scientists
- 
:::
...
Statistics is a language that scientists use to describe this complexity. Historical records of the earliest written languages reveal that humans across cultures have used some form of symbols to . For example, the Sumerian (modern day Iraq) stone tablet seen at the beginning of this chapter was used to represent where locusts and caterpillars had infested different plots of land.
...
A linear model takes the following form: [^1r_whystats-7]

[^1r_whystats-7]: I can already feel some of y'alls math anxiety rising across time and space. But remember, stats is just a language with some vocabulary we need to learn.
...
We read a model as : "the DV is a function of..." or sometimes "the DV depends on...". So I'd read this model as "rain is a function of clouds, umbrellas, the weather app status...etc." And it's good practice to leave the variables neutral (e.g., just "clouds", not "storm clouds").[^1r_whystats-9]

[^1r_whystats-9]: Later we will talk about ways to account for the fact that more umbrellas increases the chance it will rain in our model.
...
Once we add numbers and data to a linear model[^1r_whystats-10], we can quickly see :

[^1r_whystats-10]: We will get to this in Chapter 6!
...
Below are some videos, and R code, that review how to define a variable in R. Practice creating your own script in RStudio to follow along; there’s value in typing this out yourself to get that muscle memory in 💪🤘.
...
- **You don't have to take my word for it.** [Here's another guide](https://libguides.usc.edu/writingguide/introduction/researchproblem) that might offer some help, or ask for help in the class discord / office hours / lecture!
...
::: column-margin
![hi, says prof. cat](images/1_profcathi.JPG){fig-alt="a hand drawn image of a cat wearing clothes and glasses and saying hi" fig-align="left" width="136"}
:::

#### Step 2 : Develop a Theory

A scientific theory is one that is comprehensive, explanatory, and supported by evidence. For example, the theory of evolution is *comprehensive* (it relates to all nature, not just plants or animals or finches), it is *explanatory* (it’s why we and [cats](https://www.gutenberg.org/files/1227/1227-h/images/fig15.jpg) both narrow our eyes when we are scared and angry), and it is *supported* (by over 100 years of evidence[^1r_whystats-12]). 

[^1r_whystats-12]: [From fossil records to observations of fruit flies and plans](https://evolution.berkeley.edu/evolibrary/article/0_0_0/lines_01)
...
- **Null Hypothesis :** People who smoke cannabis will perform BETTER or NO DIFFERENT on a memory test than people who do not smoke marijauna. [^1r_whystats-13]
...
Science is hard, and people are very complex, which makes psychological science very hard. Unfortunately, psychology is in a bit of a [Replication Crisis](https://www.vox.com/future-perfect/21504366/science-replication-crisis-peer-review-statistics). There are two parts to the crisis:

1.  Researchers tend not to seek to replicate their (or others’) results.
2.  Systematic attempts to replicate previous research suggests that the majority of results in psychology do not replicate[^1r_whystats-14].

[^1r_whystats-14]: You can go deeper into some of the drama surrounding the replication project [here](#0). lemme know what you think on the discord thread for this week.

# Next Steps

1.  **Complete Quiz 1.**
2.  **Complete Lab 1.**
3.  **Contribute to Discussion 1.**
