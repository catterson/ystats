...
[![](images/clipboard-4017464194.png){fig-align="center"}](https://commons.wikimedia.org/wiki/File:The_oldest_writing_in_the_world_-_The_Sumerian_Stone_Tablet.jpg)
...
-   Complete the practice exercises (check-ins) and try to create some variables in R.

-   Take Quiz 1 (on our course page).

-   Think about something you would want to learn about people (or non-human animals) if you were a researcher.
:::
