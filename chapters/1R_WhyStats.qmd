...
[![A Sumerian (Modern Iraq) stone tablet representing agricultural data.](images/clipboard-4017464194.png){fig-align="center"}](https://commons.wikimedia.org/wiki/File:The_oldest_writing_in_the_world_-_The_Sumerian_Stone_Tablet.jpg)

::: callout-important
## Who Cares?

In this week’s reading, you’ll learn why students like you are required to learn the statistics, programming language, and research methods required of modern psychology (and other social sciences).

- **Part 1** covers how and why science is used by people in positions of power to study variation in ways that help them gain knowledge and influence the world.
- **Part 2** covers how to start using the programming language R to define and graph a variable to illustrate variation.
- **Part 3** reviews the scientific method, and ways that scientists can be biased by their own experiences.

**By the end of this chapter :** you will be able to define a research question you might be interested in studying, think about the focus of that question in terms of the ABCs and between vs. within-person variation, and use R to define and graph some variables.
:::

## Part 1 : Why Statistics?

Statistics is a requirement for students who want to be social scientists. This is exciting for me (your professor), and probably some students too. However, over the years I have learned this can be frustrating and stressful for students who wonder *why-the-flip* they are required to take a math class when all they just want to learn about people (or other non-human animals), ya know!??!
...
[^1r_whystats-1]: One of the reasons I love teaching is that students in the Bay Area are hella complex.
...
Statistics is a language that scientists use to describe this complexity. Historical records of the earliest written languages reveal that humans across cultures have used some form of symbols to represent data. For example, the Sumerian stone tablet seen at the beginning of this chapter was used to represent where locusts and caterpillars had infested different plots of land in modern day Iraq.

Social scientists use this language to better understand differences in people (or non-human animals), and other scientific disciplines focus on their own domains; physicists seek to understand differences (and similarities) in matter and energy, chemists seek to understand differences (and similarities) in elements and compounds, botanists seek to understand differences in plants, and economists seek to understand money.
...
Click on the tabs below to examine two different approaches to studying variation.
...
::::: columns
::: {.column width="50%"}
**Between-Person (or between-subject / intra-individual) variation** describes how individuals differ from each other. Think about ways that you differ from others; not everybody wears glasses, has the same level of silliness / seriousness / desire to cause mischief / fascination with horses.

This type of variation is not always focused on people - a study of how one country differs from other countries in terms of GDP or happiness, how one plant differs from another plant in terms of its height, or how one advertising campaign receives more clicks than another advertising campaign, would also be a form of between-individual variation.
:::

::: {.column width="50%"}
![](images/1_between_belcher_variation.webp){fig-alt="five characters who are family members of the the TV show bob’s burgers expressing a variety of emotions and striking different poses." fig-align="center" width="291"}
:::
:::::
...
::::: columns
::: {.column width="50%"}
**Within-Person (or within-subject / intra-individual) variation** describes how one individual changes over time or across different situations. Think about the person you are today - are you exactly the same as you were yesterday? A year ago? You’ve changed (varied) in ways both small (hunger, exhaustion, number of words you’ve read for this class) and large (personality, love interests, identity, etc.)

Looking to our other examples, you could also study how one country changes in happiness over time, how one plant changes in height based on the amount of sunlight it receives, or how one advertising campaign becomes less popular over time when everyone gets sick of hearing that same song that it uses repeated over and over again.
:::

::: {.column width="50%"}
![](images/clipboard-3637432840.png){width="407"}
:::
:::::
...
::::: columns
::: {.column width="50%"}
**No variation** would describe a situation in which everyone is exactly the same. I can’t think of too many situations where there is no variation; let me know on Discord if you can think of one? Life manages to express variation even in situations where scientists use their knowledge to control every known variable - while there's very little variation, not every plant has the exact same height or leaf structure in the image despite Monsanto's efforts.

While there could be a world in which no variation exists, there’s no theoretical limit to the amount of variation that there can be. Indeed, one major task of statistics - and this class - will be to quantify the amount of variation that we observe.
:::

::: {.column width="50%"}
![](images/clipboard-2911431703.png)
:::
:::::
::::::::::::
...
**A Variable** is a label for some phenomenon that has variation. I'm not sure where I first heard this, but social scientists often focus on what they call the “ABCs”. 
...
These are not rigid categories, and social scientists often debate the definitions of these terms. But they can be useful ways to think about how to think about people, and help break down a complex phenomenon into more specific components.
...
Statistics, like spoken languages, is a combination of vocabulary, rules, and culture that people use to communicate with each other.
...
### Critical and Culture in Statistics

:::: callout-tip
#### The Role of "Me-Search"
...
![](images/1_white_authors-01.png){fig-alt="another graph that illustrates the percentage of journal articles that were written by authors who were white or persons of color over the last 4 decades." fig-align="center"}

These trends are important to reflect on, because they reveal a bias in who becomes a social scientist, and what types of questions these researchers are interested in pursuing.

It's also a goal of this class to not only highlight the important contributions of non-white researchers and statisticians, but also make sure that all students in this diverse classroom feels empowered to use statistics, research methods, and R skills to ask (and answer) research questions that matter to them!
::::
...
Psychology and other social sciences uses statistics because, in part, it wants to establish itself as a real science, like physics and chemistry. I've never heard anyone use the phrase "chemistry science" because this almost feels redundant - it is implied that chemistry is a science. You don’t have to take my word for it, just look at the definitions of some common sources of psychological knowledge - introductory textbooks:
...
I’m probably showing my age looking to textbooks, so let’s check in with ChatGPT[^1r_whystats-5] to see whether the algorithmic summary of large piles of data suggests that psychology is, in fact, a “real science” : 

[^1r_whystats-5]: See the syllabus for the course ChatGPT policy. You may also be interested to read on the ethical and [environmental issues](https://bsj.studentorg.berkeley.edu/the-new-dimension-to-the-climate-crisis-chat-gpt/) surrounding this emerging technology.

![](images/1_psychsci_chatGPT_def.png){fig-align="center"}
...
::: column-margin
![You can see when scientists predict Halley’s comet to come closest to earth [here](https://theskylive.com/halley-tracker). While this is fairly accurate, I’ve seen the exact prediction change over the years - there is still some error in this prediction.](images/clipboard-3451448147.png)
:::
...
- [Nobody was carrying an umbrella today](https://walzr.com/weather-watching).
...
Think about some predictions that you have made. What knowledge informed the prediction? Did you use this prediction to influence your future behavior in some way? What kinds of predictions do psychologists make? We will chat more about these ideas in class :) but it's a core focus on why psychologists use predictions.

And so, here we are. In this document, in this required class, learning how to DO REAL SCIENCE. With statistics.
...
A linear model takes the following form: [^1r_whystats-6]

[^1r_whystats-6]: I can already feel some of y'alls math anxiety rising across time and space. But remember, stats is just a language with some vocabulary we need to learn.
...
We read a model as : "the DV is a function of..." or sometimes "the DV depends on...". So I'd read this model as "rain is a function of clouds, umbrellas, the weather app status...etc." And it's good practice to leave the variables neutral (e.g., just "clouds", not "storm clouds").[^1r_whystats-8]

[^1r_whystats-8]: Later we will talk about ways to account for the fact that more umbrellas increases the chance it will rain in our model.
...
Once we add numbers and data to a linear model[^1r_whystats-9], we can quickly see :

[^1r_whystats-9]: We will get to this in Chapter 6!
...
For this model, I've organized the focus of the research question on the left-hand side and listed the three other variables to the right, using neutral descriptions (e.g., 'water intake' rather than 'drinking more water'). I also included error at the end of my model to account for the fact that some people who play music, drink water, and eat ice cream are, in fact, not happy. I also didn't add other variables that might be related to happiness, since these were not part of the researcher's statement.
:::

## Part 2 : Defining Variables in R

In Part 1, we learned how variables were one of the core units of statistics (and science). In Part 2, you'll learn how to define (and graph) variables in R. We will talk much more about variables (and graphs) in future chapters; this is just an introduction.

Below are some videos, and R code, that review how to define a variable in R. Practice creating your own script in RStudio to follow along; there’s value in typing this out yourself to get that muscle memory in 💪🤘. *Make sure you have R and RStudio installed on your computer, and have watched the videos giving a tour of these programs in the Introduction.* Let us know if you get stuck on the class discord; happy to help provide some support or additional videos as needed.

### Numeric Variables in R

As you'll learn in Chapter 2, some variables are described with numbers. For example, you might be interested in measuring the number of pets that a person has, and this number can vary from 0 (no pets) to an infinite number (in theory.)

#### Defining a Numeric Variable in R
...
#### Graphing Numeric Variables in R
...
Other variables are better described as categories. For example, if you are interested in measuring a person's favorite type of pet, you might have them choose from a list of options : "turtle", "rabbit", "rat", "dog", "dog", "rat", etc.

#### Defining a Categorical Variable in R
...
#### Graphing a Categorical Variables in R
...
- **Look at faculty webpages or a future employeer, and see what they (and / or their graduate students) are working on.** Does anything seem interesting to you? Who looks like they might be cool to work with? What aspects of their research question or job might you study with this project?
...
- **You don't have to take my word for it.** [Here's another guide](https://libguides.usc.edu/writingguide/introduction/researchproblem) that might offer some help, or ask for help in the class discord / office hours!
...
+==============================================================+======================================================================================================================================================================================================================================================+=======================================================================================================================================================+================================================================================+
| Why do people do the things that they do?                    | Great start, but these topics are too broad! Which things? Which people? What aspects of mental health?                                                                                                                                              | Try to focus by identifying a specific aspect of people's affect, behavior, or cognition that you care about, or a specific group of people to study. | Why do people overshare personal details in social settings?                   |
|                                                              |                                                                                                                                                                                                                                                      |                                                                                                                                                       |                                                                                |
| How does social media influence mental health?               |                                                                                                                                                                                                                                                      |                                                                                                                                                       | How does social media usage influence social anxiety in teenagers?             |
+--------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+
| Do sociopaths dream about kittens more than non-sociopaths?  | Interesting topics! However, it would be really difficult to study with the resources that a student in this class would have. (e.g., it would be hard to find sociopaths to give surveys to; hard to rent out an fMRI to measure voxel activation.) | Think about ways to adapt the question to account for people that you could study, and variables that you could more easily measure.                  | How do dreams influence people's future behavior?                              |
|                                                              |                                                                                                                                                                                                                                                      |                                                                                                                                                       |                                                                                |
| How does inter-generational trauma change our neural wiring? |                                                                                                                                                                                                                                                      |                                                                                                                                                       | What are some strategies that help people heal from inter-generational trauma? |
+--------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------+

::: {.callout-tip title="Prof. Cat Has An Idea"}
...
::: column-margin
![](images/clipboard-818370036.png){width="95"}
:::

#### Step 2 : Develop a Theory

A scientific theory is one that is comprehensive, explanatory, and supported by evidence. For example, the theory of evolution is *comprehensive* (it relates to all nature, not just plants or animals or finches), it is *explanatory* (it’s why we and [cats](https://www.gutenberg.org/files/1227/1227-h/images/fig15.jpg) both narrow our eyes when we are scared and angry), and it is *supported* (by over 100 years of evidence[^1r_whystats-11]). 

[^1r_whystats-11]: [From fossil records to observations of fruit flies and plans](https://evolution.berkeley.edu/evolibrary/article/0_0_0/lines_01)
...
### The Scientific Method Is Never Easy

Science is hard, and people are very complex, which makes psychological science very hard. Unfortunately, psychology is in a bit of a [Replication Crisis](https://www.vox.com/future-perfect/21504366/science-replication-crisis-peer-review-statistics).

There are two parts to the crisis :

1.  Researchers tend not to seek to replicate their (or others’) results.
2.  Systematic attempts to replicate previous research suggests that the majority of results in psychology do not replicate[^1r_whystats-13].

[^1r_whystats-13]: You can go deeper into some of the drama surrounding the replication project [here](#0). lemme know what you think on the discord thread for this week.
